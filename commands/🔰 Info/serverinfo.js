...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<a:arrow:1168762387067846687> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:NO:1169479454918180937> \`No Channel\`"}`, true)
      embed.addField("**<a:arrow:1168762387067846687> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:NO:1169479454918180937> \`No Channel\`"}`, true)
      embed.addField("**<a:arrow:1168762387067846687> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:NO:1169479454918180937> \`No Channel\`"}`, true)

      embed.addField("**<a:arrow:1168762387067846687> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<a:arrow:1168762387067846687> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<a:arrow:1168762387067846687> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<a:arrow:1168762387067846687> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:NO:1169479454918180937> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<a:arrow:1168762387067846687> SERVER DISCOVERY SPLASH:**`)
