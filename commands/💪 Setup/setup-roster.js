  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor(client.getAuthor('Server Roster Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/facebook/65/page-with-curl_1f4c3.png', 'https://discord.gg/bestgamershk'))
      ...
      async function second_layer(SetupNumber, menuoptiondata){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(SetupNumber + " Server Roster Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/facebook/65/page-with-curl_1f4c3.png", "https://discord.gg/bestgamershk")
      ...
      async function handle_the_picks(optionhandletype, SetupNumber, ticket) {
        ...
        switch (optionhandletype) {
          ...
          case "Edit Roster Style":{
            ...
            try{
              for(const emoji of [":one:", ":two:", ":three:", ":four:", ":five:", ":six:", ":seven:"])
               tempmsg.react(emoji)
            }catch(e){
              console.log(e.stack ? String(e.stack).grey : String(e).grey)
            }
