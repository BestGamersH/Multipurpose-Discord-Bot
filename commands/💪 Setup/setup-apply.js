  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://discord.gg/friendsmp")
      ...
      try {
        ...
        case `${pre}.last_verify`: {
          ...
          var embed = new Discord.MessageEmbed()
            .setFooter(client.getFooter(es))
            .setColor(es.color)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable219"])) //BestGamersHK#1213
            .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable220"])) //BestGamersHK#1213
            .setTimestamp()
          message.reply({
            embeds: [embed]
          });
