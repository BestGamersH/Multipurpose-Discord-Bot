   ...
   run: async (client, message, args, cmduser, text, prefix) => {
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       var members = message.guild.members.cache.filter(member => member.roles.cache.has(role.id)).map(this_Code_is_by_bestgamershk21213 => this_Code_is_by_bestgamershk21213);
